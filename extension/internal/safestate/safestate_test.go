...
//
// This test file verifies the three failure modes the vault must handle:
...
// If the TEE fails or becomes unavailable, the vault enters a
...
// If PMW is unavailable, cross-chain execution pauses but
...
// FDC attestation delay — verify the vault enters safe state.
